...
use smithay::{
    ...
    reexports::{
        ...
        wayland_protocols::ext::workspace,
        wayland_server::{
...
pub struct Beyond {
    ...
    pub seat_state: SeatState<Beyond>,
...
impl Beyond {
    pub fn new(event_loop: &mut EventLoop<Self>, display: Display<Self>) -> Self {
        ...
        // Some of them require us to implement traits on the Beyond state,
    ...
    pub fn surface_under(
        ...
        //        let workspace_pos = pos + self.camera_pos;
...
/// Data associated with a wayland client that connects to Beyond.
